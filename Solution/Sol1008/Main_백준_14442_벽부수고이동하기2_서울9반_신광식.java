...
public class Main_백준_14442_벽부수고이동하기2_서울9반_신광식 {
	...
	// visit[n][m][1] => 벽을 1번 부수고 방문
	// visit[n][m][2] => 벽을 2번 부수고 방문
	// visit[n][m][k] => 벽을 k번 부수고 방문
	static int bfs() {
		...
		while (!q.isEmpty()) {
			...
			for (int d = 0; d < 4; d++) {
				...
				if (nx >= 0 && nx < n && ny >= 0 && ny < m) {
					if (map[nx][ny] == '1' && curr.thru < k && visit[nx][ny][curr.thru + 1] == false) {
						// 1번
